...
Password reset email is sent, and the reset link works correctly.
...
Cart icon updates the item count immediately.
...
Cart displays the product name, image, price, quantity, and total.
...
“I agree with terms” checkbox is required to proceed.
...
Order can be placed successfully with the required valid data.
